...
with open('input', 'r') as f:
    ...
    # start_position = [[2, 5], 0]
    start_position = [[20, 36], 0]
    ...
    while queue and not found:
        ...
        height = ord('z') if grid[position[0]][position[1]] == 'E' else ord(grid[position[0]][position[1]])
        ...
        for d in directions:
            ...
            new_height = ord('a') if grid[new_position[0]][new_position[1]] == 'S' else ord(grid[new_position[0]][new_position[1]])

            if new_height - height >= -1:
                if grid[new_position[0]][new_position[1]] == 'S' or grid[new_position[0]][new_position[1]] == 'a':
